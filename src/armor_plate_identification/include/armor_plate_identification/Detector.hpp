...
private:
	...
	/**
	 * @brief 找到所有灯条的轮廓，进行简单的筛选--面积还有长宽比
	 ...
	 * @return 是否匹配成功
	 */
	bool checkArmorGeometry(const Lights& light_left, const Lights& light_right);
